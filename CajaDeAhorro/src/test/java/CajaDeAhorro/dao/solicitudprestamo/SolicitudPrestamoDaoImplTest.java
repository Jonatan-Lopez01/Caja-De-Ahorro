...
public class SolicitudPrestamoDaoImplTest {
    ...
    private SolicitudPrestamo crearSolicitudPrestamo(int id_socio, double monto_prestado,int numCuenta, String tipo_prestamo, Timestamp fecha_solicitud, int plazo, int num_montos, String descripcion, String estado) {
        ...
        nuevaSolicitud.setnumCuenta(numCuenta);
        ...
        assertEquals("El numero de cuenta no coincide", nuevaSolicitud.getnumCuenta(), solicitudCreada.getnumCuenta());
    ...
    public void testCrearSolicitudPrestamo() {
        SolicitudPrestamo solicitudCreada = crearSolicitudPrestamo(1, 5000.0,1, "Personal", Timestamp.valueOf("2024-05-29 00:00:00"), 24, 12, "Préstamo para vacaciones", "En revisión");
        ...
        System.out.println("numero_cuenta: " + solicitudCreada.getnumCuenta());
    ...
    public void testObtenerSolicitudPrestamoPorId() {
        ...
        System.out.println("numero_cuenta: " + solicitudObtenida.getnumCuenta());
    ...
    public void testObtenerTodasLasSolicitudesPrestamo() {
        ...
        for (SolicitudPrestamo solicitudIndividual : listaDeSolicitudes) {
            ...
            System.out.println("numero_cuenta: " + solicitudIndividual.getnumCuenta());
    ...
    public void testActualizarSolicitudPrestamo() {
        ...
        System.out.println("numero_cuenta: " + solicitudDeLaBaseDeDatos.getnumCuenta());
        ...
        System.out.println("numero_cuenta: " + solicitudLocal.getnumCuenta());
        ...
        assertEquals("El monto prestado no coincide", solicitudLocal.getMontoPrestado(), solicitudDeLaBaseDeDatos.getMontoPrestado(), 0.01);
         assertEquals("El numero de cuenta no coincide", solicitudLocal.getnumCuenta(), solicitudDeLaBaseDeDatos.getnumCuenta());
