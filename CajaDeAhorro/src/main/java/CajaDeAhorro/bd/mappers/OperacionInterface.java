...
/**
 * Interfaz para definir operaciones relacionadas con la entidad Operacion en la
 * base de datos. Permite la creación, actualización, eliminación y consulta de
 * operaciones. También proporciona un método para obtener la última operación
...
public interface OperacionInterface {
    ...
    boolean realizarRetiro(int numeroCuenta, double cantidad);
}
