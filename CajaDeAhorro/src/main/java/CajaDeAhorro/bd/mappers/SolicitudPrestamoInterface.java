...
/**
 * Interfaz para definir operaciones relacionadas con la entidad
 * SolicitudPrestamo en la base de datos. Permite la creación, actualización,
 * eliminación y consulta de solicitudes de préstamo. También proporciona un
 * método para obtener la última solicitud de préstamo creada en la base de
 * datos.
 *
 * @author Ramses
 */
public interface SolicitudPrestamoInterface {
